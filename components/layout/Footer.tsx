        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li>
                <a href={`tel:${phoneHref}`} className="flex items-center gap-2 text-white font-bold text-base hover:text-blue-200 transition-colors">
              ...
              <li>
                <a
                  href={`https://wa.me/${phoneHref.replace(/\D/g, '')}`}
                  target="_blank"
