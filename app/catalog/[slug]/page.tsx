          ...
          <div className="mb-6">
            {currentPrice > 0 ? (
              ...
              <div className="bg-slate-50 rounded-xl p-4">
                <div className="text-2xl font-bold text-slate-800">Цена по запросу</div>
                <div className="text-sm text-slate-500 mt-1">Зависит от конфигурации и объекта — уточним при звонке</div>
                <a
                  href="tel:+79001234567"
                  className="mt-3 inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-brand-600 text-white font-semibold text-sm hover:bg-brand-700 transition-colors"
                >
