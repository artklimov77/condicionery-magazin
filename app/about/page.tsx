...
const values = [
  {
    title: 'Честная цена',
    desc: 'Не держим склад — закупаем под каждый заказ. Нет затрат на хранение, нет наценки за это.',
    icon: (
  ...
  },
  {
    ...
    desc: 'Кондиционер — сложная покупка. Неверно подобранная мощность обернётся проблемами через сезон. Разберёмся вместе.',
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
  ...
  },
  {
    ...
    desc: 'Только официальные поставки через проверенных дистрибьюторов. Гарантия производителя, все сертификаты.',
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
  ...
  },
  {
    ...
    desc: 'Подаёте заявку — цена фиксируется на момент обращения. Рост курса после оформления нас не касается.',
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
    ...
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="mb-12">
        ...
        <h1 className="text-3xl sm:text-4xl font-bold text-slate-900 mb-4 text-balance">
          Nordic Air — климатическая техника в Санкт-Петербурге
        </h1>
        <p className="text-lg text-slate-500 leading-relaxed max-w-2xl">
          Интернет-магазин, работающий напрямую с крупными дистрибьюторами. Подбираем, закупаем
          и доставляем кондиционеры по СПб и Ленинградской области.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-14">
        <div>
          ...
          <p className="text-slate-600 leading-relaxed mb-4">
            Мы не держим большой склад — принимаем заявки, подбираем оптимальную модель под ваш запрос
            и закупаем напрямую у проверенных дистрибьюторов. Это позволяет предлагать честные цены
            без наценки за хранение.
          </p>
          <p className="text-slate-600 leading-relaxed">
            Работаем по Санкт-Петербургу и Ленинградской области. Доставляем оборудование
            и проводим монтаж силами собственных специалистов.
          </p>
        </div>
        <div>
          ...
          <p className="text-slate-600 leading-relaxed">
            Поэтому у нас есть подборщик, гайд по выбору и живой менеджер, который перезвонит
      ...
      <div className="mb-14">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
          {values.map((v) => (
            <div key={v.title} className="flex gap-4 p-5 bg-white rounded-2xl border border-slate-100 shadow-sm">
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        <Link
          href="/quiz"
          className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl bg-accent text-white font-bold text-base hover:bg-amber-600 transition-colors"
        >
        ...
        <Link
          href="/contacts"
          className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl border-2 border-slate-300 text-slate-700 font-semibold text-base hover:border-brand-600 hover:text-brand-600 transition-colors"
        >
          Связаться с нами
        </Link>
      </div>
